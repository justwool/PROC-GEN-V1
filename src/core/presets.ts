...
const paletteStableIridescent: PaletteRanges = {
  palA: [{ min: 0.34, max: 0.62 }, { min: 0.3, max: 0.58 }, { min: 0.36, max: 0.66 }],
  palB: [{ min: 0.25, max: 0.62 }, { min: 0.2, max: 0.56 }, { min: 0.28, max: 0.66 }],
  palC: [{ min: 0.55, max: 1.7 }, { min: 0.65, max: 1.8 }, { min: 0.5, max: 1.65 }],
  palD: [{ min: 0.0, max: 1.15 }, { min: 0.05, max: 1.2 }, { min: 0.0, max: 1.25 }]
};
...
export const PRESETS: Preset[] = [
  {
    ...
    paramRanges: mergeRanges({
      warp: { min: 1.25, max: 2.5 },
      fold: { min: 0.0, max: 0.4 },
      tileMix: { min: 0.0, max: 0.3 },
      sweep: { min: 0.1, max: 0.62 },
      ribbons: { min: 0.62, max: 1.0 },
      gloss: { min: 0.42, max: 1.0 },
      layers: { min: 4, max: 6 },
      smear: { min: 0.25, max: 1.0 },
      smearTaps: { min: 10, max: 24 },
      panels: { min: 1, max: 4 },
      panelHard: { min: 0.3, max: 1.0 },
      steps: { min: 0, max: 32 },
      rgbSplit: { min: 0.12, max: 0.58 },
      blendMode: { min: 0, max: 4 },
  ...
  },
  {
    ...
    paramRanges: mergeRanges({
      warp: { min: 0.7, max: 1.9 },
      fold: { min: 0.25, max: 0.78 },
      tileMix: { min: 0.25, max: 0.82 },
      tileCount: { min: 6, max: 14 },
      sweep: { min: 0.22, max: 0.78 },
      gloss: { min: 0.25, max: 0.85 },
      layers: { min: 3, max: 6 },
      smear: { min: 0.38, max: 1.0 },
      smearTaps: { min: 12, max: 24 },
      panels: { min: 2, max: 4 },
      panelHard: { min: 0.72, max: 1.0 },
      steps: { min: 10, max: 56 },
      rgbSplit: { min: 0.02, max: 0.38 },
      blendMode: { min: 0, max: 4 },
      frameBands: { min: 2, max: 4 }
    }),
    paletteRanges: paletteStableIridescent
  },
  {
    ...
    paramRanges: mergeRanges({
      ...
      warp: { min: 0.6, max: 1.8 },
      fold: { min: 0.08, max: 0.62 },
      tileMix: { min: 0.0, max: 0.35 },
      ribbons: { min: 0.35, max: 0.85 },
      gloss: { min: 0.2, max: 0.82 },
      layers: { min: 4, max: 6 },
      smear: { min: 0.18, max: 0.65 },
      smearTaps: { min: 8, max: 22 },
      panels: { min: 2, max: 4 },
      panelHard: { min: 0.45, max: 1.0 },
      steps: { min: 18, max: 64 },
      rgbSplit: { min: 0.08, max: 0.62 },
      blendMode: { min: 0, max: 4 },
      frameBands: { min: 1, max: 4 }
    }),
    paletteRanges: paletteStableIridescent
  },
  {
    ...
    paramRanges: mergeRanges({
      ...
      warp: { min: 0.75, max: 2.0 },
      tileMix: { min: 0.15, max: 0.62 },
      ribbons: { min: 0.55, max: 1.0 },
      sharp: { min: 1.2, max: 3.0 },
      gloss: { min: 0.62, max: 1.0 },
      layers: { min: 3, max: 6 },
      smear: { min: 0.08, max: 0.58 },
      smearTaps: { min: 6, max: 18 },
      panels: { min: 2, max: 4 },
      panelHard: { min: 0.8, max: 1.0 },
      steps: { min: 14, max: 64 },
      rgbSplit: { min: 0.0, max: 0.28 },
      blendMode: { min: 1, max: 4 },
      frameBands: { min: 2, max: 4 }
    }),
    paletteRanges: paletteStableIridescent
  },
  {
    ...
    paramRanges: mergeRanges({
      warp: { min: 0.55, max: 1.55 },
      fold: { min: 0, max: 0.35 },
      tileMix: { min: 0, max: 0.3 },
      ribbons: { min: 0.2, max: 0.72 },
      sharp: { min: 0.2, max: 1.2 },
      gloss: { min: 0.08, max: 0.72 },
      layers: { min: 2, max: 5 },
      smear: { min: 0.25, max: 0.92 },
      smearTaps: { min: 10, max: 24 },
      panels: { min: 0, max: 3 },
      panelHard: { min: 0.12, max: 0.68 },
      steps: { min: 0, max: 28 },
      rgbSplit: { min: 0.18, max: 0.78 },
  ...
  },
  {
    ...
    paramRanges: mergeRanges({
      ...
      fAng: { min: 6, max: 18 },
      warp: { min: 0.75, max: 2.0 },
      ribbons: { min: 0.35, max: 0.92 },
      sharp: { min: 0.95, max: 2.9 },
      layers: { min: 4, max: 6 },
      smear: { min: 0.2, max: 0.9 },
      smearTaps: { min: 12, max: 24 },
      panels: { min: 2, max: 4 },
      panelHard: { min: 0.5, max: 1.0 },
      steps: { min: 16, max: 64 },
      rgbSplit: { min: 0.0, max: 0.62 },
      blendMode: { min: 0, max: 4 },
      frameBands: { min: 2, max: 4 }
    }),
    paletteRanges: paletteStableIridescent
